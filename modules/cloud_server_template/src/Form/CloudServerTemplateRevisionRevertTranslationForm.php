 ...
 */
class CloudServerTemplateRevisionRevertTranslationForm extends CloudServerTemplateRevisionRevertForm {
  ...
  /**
   * Constructs a new CloudServerTemplateRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'cloud_server_template_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $cloud_server_template_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $cloud_server_template_revision);
