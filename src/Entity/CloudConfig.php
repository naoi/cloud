...
class CloudConfig extends RevisionableContentEntityBase implements CloudConfigInterface, CloudContextInterface {
  ...
  public function preSave(EntityStorageInterface $storage) {
    ...
    // If no revision author has been set explicitly, make the cloud_config owner the
    // revision author.
   ...
   * Corresponds with the #machine_name widget type when adding a new CloudConfig
   *
   * @param $cloud_context
